...
func NewProvider(providerConfig options.Provider) (Provider, error) {
	...
	case options.NCOIDCProvider:
		return NewNCOIDCProvider(providerData, providerConfig.OIDCConfig), nil
	default:
...
func providerRequiresOIDCProviderVerifier(providerType options.ProviderType) (bool, error) {
	...
	case options.BitbucketProvider, options.DigitalOceanProvider, options.FacebookProvider, options.GitHubProvider,
		...
		return false, nil
	case options.ADFSProvider, options.AzureProvider, options.GitLabProvider, options.KeycloakOIDCProvider, options.OIDCProvider, options.NCOIDCProvider:
		return true, nil
	default:
